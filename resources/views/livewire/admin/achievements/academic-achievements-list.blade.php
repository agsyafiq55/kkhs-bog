<div class="py-6">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2">
                                ...
                                <button
                                    onclick="event.preventDefault(); Flux.modal('delete-achievement-{{ $achievement->id }}').show();"
    ...
    <flux:modal name="delete-achievement-{{ $achievement->id }}" class="min-w-[22rem]">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Delete achievement?</flux:heading>

                <flux:text class="mt-2">
                    <p>You're about to delete {{ $achievement->exam_type }} ({{ $achievement->year }}) achievement data.</p>
            ...
            <div class="flex gap-2">
                ...
                <flux:button
                    ...
                    onclick="Flux.modal('delete-achievement-{{ $achievement->id }}').close();"
                    variant="danger">
                    Delete achievement
                </flux:button>
            </div>
