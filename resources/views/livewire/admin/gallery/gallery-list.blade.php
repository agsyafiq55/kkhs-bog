<div class="py-6">
            ...
            <div class="group relative border-neutral-200 bg-zinc-50 dark:bg-zinc-900 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-100 dark:border-zinc-700"
                ...
                <div class="p-5">
                    ...
                    <div class="flex justify-end space-x-2 mt-4">
                        ...
                        <flux:button 
                            x-on:click="event.stopPropagation(); $flux.modal('delete-gallery-{{ $gallery->id }}').show()"
    ...
    @foreach($galleries as $gallery)
        <flux:modal name="delete-gallery-{{ $gallery->id }}" class="min-w-[22rem]">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">Delete gallery image?</flux:heading>

                    <flux:text class="mt-2">
                        <p>You're about to delete "{{ $gallery->img_name }}".</p>
                ...
                <div class="flex gap-2">
                    ...
                    <flux:button 
                        ...
                        x-on:click="$flux.modal('delete-gallery-{{ $gallery->id }}').close()"
                        variant="danger">
                        Delete image
                    </flux:button>
                </div>
